...
export const CHAIN_ID_PREFERRED_DEPOSIT_TOKEN: Partial<Record<number, string>> = {
...
} satisfies Record<SettlementChainId, string>;
...
export const ENDPOINT_ID_TO_CHAIN_ID = mapValues(invert(CHAIN_ID_TO_ENDPOINT_ID), (value) =>
  parseInt(value)
) as Partial<Record<number, SettlementChainId | SourceChainId>>;
