...
const INDEXER_URLS = {
  ...
  [AVALANCHE]: {
    ...
    subsquid: "https://gmx.squids.live/gmx-synthetics-avalanche@5eaa69/api/graphql",
  },
  ...
  [ARBITRUM_SEPOLIA]: {
    subsquid: "https://gmx.squids.live/gmx-synthetics-arb-sepolia@5eaa69/api/graphql",
  },

  [BOTANIX]: {
    subsquid: "https://gmx.squids.live/gmx-synthetics-botanix@5eaa69/api/graphql",
    syntheticsStats:
  ...
  [MEGAETH]: {
    subsquid: "https://gmx.squids.live/gmx-synthetics-megaeth@5eaa69/api/graphql",
    syntheticsStats:
