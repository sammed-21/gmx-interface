...
function FundingHistoryItemLabel({
  ...
  const key = `${operation}${isExecutionError ? "-failed" : ""}` as keyof typeof labels;
...
function GmxAccountBalanceTooltipContent() {
  return (
    <Trans>
      ...
      <ExternalLink href="https://docs.gmx.io/docs/trading/overview/#multichain-trading">Read more</ExternalLink>.
    </Trans>
  );
}
